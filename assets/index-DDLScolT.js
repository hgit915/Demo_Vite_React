...
`),oe=ee({createStyledComponent:g("div",{name:"MuiContainer",slot:"Root",overridesResolver:(e,t)=>{const{ownerState:i}=e;return[t.root,t[`maxWidth${h(String(i.maxWidth))}`],i.fixed&&t.fixed,i.disableGutters&&t.disableGutters]}}),useThemeProps:e=>G({props:e,name:"MuiContainer"})}),ie=oe,ae=g(q)(({theme:e})=>`
...
`);var b={},re=I;Object.defineProperty(b,"__esModule",{value:!0});var j=b.default=void 0,ne=re(A()),de=s;j=b.default=(0,ne.default)((0,de.jsx)("path",{d:"m12 4-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"}),"ArrowForward");const ce=g("div")(({theme:e})=>`
...
`),C=p.memo(e=>{const{imgList:t}=e;let i={lazyLoad:!0,dots:!0,infinite:!0,speed:500,slidesToShow:1,slidesToScroll:1,arrows:!0,autoplay:!0,autoplaySpeed:4e3};return s.jsx(ce,{children:s.jsx(F,{...i,children:t==null?void 0:t.slice(0,4).map((n,r)=>s.jsx("img",{src:`${L}/jpg/${n}`,className:"img"},r))})})});C.propTypes={imgList:f.array};const k=p.memo(({itemData:e,directToPage:t})=>{const{name:i,description:n,imageUrlList:r,areaInfo:x,bedInfo:o,maxPeople:a,price:d,_id:c}=e;return s.jsxs(ae,{children:[s.jsx("div",{className:"cover",children:s.jsx(C,{imgList:r},c)}),s.jsxs("div",{onClick:()=>t(c),className:"info",children:[s.jsx("div",{className:"title",children:i}),s.jsx("div",{className:"subTitle",children:n}),s.jsx(H,{area:x,bed:o,maxPeople:a}),s.jsx("div",{className:"linear"}),s.jsxs("div",{className:"price",children:["NT ",O(d,!0),s.jsx(j,{fontSize:"large",color:"primary"})]})]})]})});k.propTypes={itemData:f.object,directToPage:f.func};const je=p.memo(()=>{const e=D(),{rooms:t}=B(r=>({rooms:r.room.rooms}),M);p.useEffect(()=>{e(E())},[e]);const i=U(),n=r=>{i(`/detail/${r}`)};return s.jsxs(se,{children:[s.jsx("div",{className:"carousel"}),s.jsxs(ie,{maxWidth:"md",children:[s.jsx("div",{className:"title",children:"房型選擇"}),s.jsx("div",{className:"desc",children:"各種房型，任您挑選"}),t?s.jsx("ul",{children:t==null?void 0:t.map(r=>s.jsx(k,{directToPage:n,itemData:r},r._id))}):s.jsx(X,{variant:"rounded",height:300})]})]})});export{je as default};

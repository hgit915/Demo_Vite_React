import{_ as m,c as N,a as g,r as p,b as S,j as s,d as T,u as _,e as z,g as P,s as u,f as D,i as G,I,P as v,h as L,k as B,l as M,m as E,n as U}from"./index-RMHZEOjW.js";import{B as q}from"./Box-Zcqd4hXM.js";import{r as A,S as H,B as O,t as F}from"./format-COQRO5Vx.js";import{s as V}from"./styled-D0JrmBF1.js";const X=["className","component","disableGutters","fixed","maxWidth","classes"],J=N(),K=V("div",{name:"MuiContainer",slot:"Root",overridesResolver:(t,e)=>{const{ownerState:a}=t;return[e.root,e[`maxWidth${g(String(a.maxWidth))}`],a.fixed&&e.fixed,a.disableGutters&&e.disableGutters]}}),Q=t=>_({props:t,name:"MuiContainer",defaultTheme:J}),Y=(t,e)=>{const a=d=>P(e,d),{classes:r,fixed:n,disableGutters:h,maxWidth:o}=t,i={root:["root",o&&`maxWidth${g(String(o))}`,n&&"fixed",h&&"disableGutters"]};return z(i,a,r)};function Z(t={}){const{createStyledComponent:e=K,useThemeProps:a=Q,componentName:r="MuiContainer"}=t,n=e(({theme:o,ownerState:i})=>m({width:"100%",marginLeft:"auto",boxSizing:"border-box",marginRight:"auto",display:"block"},!i.disableGutters&&{paddingLeft:o.spacing(2),paddingRight:o.spacing(2),[o.breakpoints.up("sm")]:{paddingLeft:o.spacing(3),paddingRight:o.spacing(3)}}),({theme:o,ownerState:i})=>i.fixed&&Object.keys(o.breakpoints.values).reduce((d,l)=>{const x=l,c=o.breakpoints.values[x];return c!==0&&(d[o.breakpoints.up(x)]={maxWidth:`${c}${o.breakpoints.unit}`}),d},{}),({theme:o,ownerState:i})=>m({},i.maxWidth==="xs"&&{[o.breakpoints.up("xs")]:{maxWidth:Math.max(o.breakpoints.values.xs,444)}},i.maxWidth&&i.maxWidth!=="xs"&&{[o.breakpoints.up(i.maxWidth)]:{maxWidth:`${o.breakpoints.values[i.maxWidth]}${o.breakpoints.unit}`}}));return p.forwardRef(function(i,d){const l=a(i),{className:x,component:c="div",disableGutters:W=!1,fixed:$=!1,maxWidth:y="lg"}=l,R=S(l,X),b=m({},l,{component:c,disableGutters:W,fixed:$,maxWidth:y}),w=Y(b,r);return s.jsx(n,m({as:c,ownerState:b,className:T(w.root,x),ref:d},R))})}const ee="/Demo_Vite_React/assets/banner-BiRXWkwt.png",te=u("div")(({theme:t})=>`
...
`);var f={},ie=G;Object.defineProperty(f,"__esModule",{value:!0});var j=f.default=void 0,re=ie(A()),ne=s;j=f.default=(0,re.default)((0,ne.jsx)("path",{d:"m12 4-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"}),"ArrowForward");const de=u("div")(({theme:t})=>`

...
`),C=p.memo(e=>{const{imgList:t}=e;let a={lazyLoad:!0,dots:!0,infinite:!0,speed:500,slidesToShow:1,slidesToScroll:1,arrows:!0,autoplay:!0,autoplaySpeed:4e3};return o.jsx(de,{children:o.jsx(H,{...a,children:t==null?void 0:t.slice(0,4).map((n,r)=>o.jsx("img",{src:`${D}/jpg/${n}`,className:"img"},r))})})});C.propTypes={imgList:f.array};const k=p.memo(({itemData:e,directToPage:t})=>{const{name:a,description:n,imageUrlList:r,areaInfo:x,bedInfo:s,maxPeople:i,price:d,_id:c}=e;return o.jsxs(ae,{children:[o.jsx("div",{className:"cover",children:o.jsx(C,{imgList:r},c)}),o.jsxs("div",{onClick:()=>t(c),className:"info",children:[o.jsx("div",{className:"title",children:a}),o.jsx("div",{className:"subTitle",children:n}),o.jsx(O,{area:x,bed:s,maxPeople:i}),o.jsx("div",{className:"linear"}),o.jsxs("div",{className:"price",children:["NT ",F(d,!0),o.jsx(j,{fontSize:"large",color:"primary"})]})]})]})});k.propTypes={itemData:f.object,directToPage:f.func};const ue=p.memo(()=>{const e=B(),{rooms:t}=M(r=>({rooms:r.room.rooms}),E);p.useEffect(()=>{e(U())},[e]);const a=q(),n=r=>{a(`/detail/${r}`)};return o.jsxs(te,{children:[o.jsx("div",{className:"carousel"}),o.jsxs(oe,{maxWidth:"md",children:[o.jsx("div",{className:"title",children:"房型選擇"}),o.jsx("div",{className:"desc",children:"各種房型，任您挑選"}),o.jsx("ul",{children:t==null?void 0:t.map(r=>o.jsx(k,{directToPage:n,itemData:r},r._id))})]})]})});export{ue as default};
